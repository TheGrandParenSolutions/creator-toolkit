  ...
  return (
    <div className="relative w-full">
      <input
        ...
        className={`w-full rounded-3xl border-[0.5px] bg-transparent py-2 pl-4 pr-20 text-xs shadow-sm transition hover:shadow-lg focus:border-2 focus:shadow-xl focus:outline-none dark:shadow-gray-800 lg:text-base ${
          loading
            ? "text-gray-400"
