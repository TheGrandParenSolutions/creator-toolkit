...
export const CTAnimatedButton: FC<AnimatedButtonProps> = props => {
  ...
  return (
    <Button
      ...
      className={`relative flex !rounded-[2.5rem] items-center justify-center overflow-hidden border border-none bg-white text-black transition-all duration-300 ${buttonStyles} ${
        loading &&
