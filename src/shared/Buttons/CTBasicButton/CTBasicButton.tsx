  ...
  return (
    ...
    >
      ...
      <button
        ...
        className={`relative mx-auto flex max-h-[50px]  min-h-[46px]  w-full  items-center justify-center
        rounded-3xl border border-zinc-300
                   bg-zinc-50 bg-size-200 bg-pos-0 px-4 py-2 text-sm font-semibold text-zinc-800 shadow-ct-light
                   transition duration-[350ms] hover:bg-zinc-200
                  hover:bg-pos-100 hover:text-black
                  dark:border-zinc-700 
                  dark:bg-zinc-800 dark:text-zinc-100
                  dark:shadow-ct-dark dark:hover:bg-zinc-900 dark:hover:text-white  
                  sm:w-auto sm:max-w-none md:max-h-[60px]
                  md:min-h-[56px] md:px-6 md:py-3 md:text-base 
                  ${className ? className : ""}
