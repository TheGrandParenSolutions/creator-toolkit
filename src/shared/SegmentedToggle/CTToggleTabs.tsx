...
const CTToggleTabs: React.FC<CTToggleTabsProps> = ({
  ...
  return (
    <div className="relative whitespace-nowrap max-w-4xl flex w-full items-center justify-between gap-2 rounded-full border border-solid border-[var(--main-yellow)] bg-transparent p-2 dark:border-2 dark:border-black dark:bg-gray-800">
