...
<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
	<g fill="none" stroke="currentColor" stroke-linecap="round" stroke-width="1.5">
		...
		<path d="m2 12.5l1.752-1.533a2.3 2.3 0 0 1 3.14.105l4.29 4.29a2 2 0 0 0 2.564.222l.299-.21a3 3 0 0 1 3.731.225L21 18.5" opacity="0.5" />
...
export const VideoDownloadIcon = IconRenderer(
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
	<g fill="none" stroke="currentColor" stroke-linecap="round" stroke-width="1.5">
		...
		<path stroke-linejoin="round" d="m6.754 12.395l1.968 1.967a.46.46 0 0 0 .65 0l1.968-1.967" />
...
<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 20 20">
	<g fill="currentColor">
		...
		<path fill-rule="evenodd" d="M5.25 16a.5.5 0 0 1 .5-.5h8.737a.5.5 0 1 1 0 1H5.75a.5.5 0 0 1-.5-.5" clip-rule="evenodd" />
	</g>
</svg>
)
...
<svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 32 32">
	<g fill="none">
		<path fill="#fcd53f" d="M30 16c0 7.732-6.268 14-14 14S2 23.732 2 16S8.268 2 16 2s14 6.268 14 14" />
		<path fill="#f9c23c" d="M15.5 7a1.5 1.5 0 1 0 0-3a1.5 1.5 0 0 0 0 3m-6 9a3.5 3.5 0 1 0 0-7a3.5 3.5 0 0 0 0 7M25 11.5a2.5 2.5 0 1 1-5 0a2.5 2.5 0 0 1 5 0M16.5 24a2.5 2.5 0 1 0 0-5a2.5 2.5 0 0 0 0 5m-6.311 4.74a14.05 14.05 0 0 1-5.439-4.405a3.5 3.5 0 1 1 5.439 4.406m14.693-1.918a14.04 14.04 0 0 0 4.073-5.507a3.5 3.5 0 0 0-4.074 5.507" />
	</g>
</svg>
)
...
export const MoonIcon = IconRenderer(
  <svg xmlns="http://www.w3.org/2000/svg" width="48" height="48" viewBox="0 0 48 48">
	<path fill="#45413c" d="M10.9 45.29a13.1 1.71 0 1 0 26.2 0a13.1 1.71 0 1 0-26.2 0" opacity="0.15" />
	<path fill="#656769" d="M4.63 24a19.37 19.37 0 1 0 38.74 0a19.37 19.37 0 1 0-38.74 0" />
	<path fill="#87898c" d="M24 9.19a19.36 19.36 0 0 1 19.22 17.09a19 19 0 0 0 .15-2.28a19.37 19.37 0 0 0-38.74 0a19 19 0 0 0 .15 2.28A19.36 19.36 0 0 1 24 9.19" />
	<path fill="none" stroke="#45413c" stroke-linecap="round" stroke-linejoin="round" d="M4.63 24a19.37 19.37 0 1 0 38.74 0a19.37 19.37 0 1 0-38.74 0" />
	<path fill="#87898c" d="M38.33 18.57c-1.27.93-3.36.24-4.65-1.54s-1.33-4-.06-4.9s3.36-.24 4.66 1.54s1.32 3.97.05 4.9" />
	<path fill="#525252" d="M33.62 14.51c1.27-.93 3.36-.24 4.66 1.54a5.5 5.5 0 0 1 .78 1.57a4.28 4.28 0 0 0-.78-3.92c-1.3-1.78-3.39-2.47-4.66-1.54a3 3 0 0 0-.73 3.33a2.3 2.3 0 0 1 .73-.98" />
	<path fill="none" stroke="#45413c" stroke-linecap="round" stroke-linejoin="round" d="M38.33 18.6c-1.27.93-3.36.24-4.65-1.54s-1.33-4-.06-4.9s3.36-.24 4.66 1.54s1.32 3.98.05 4.9" />
	<path fill="#87898c" d="M9 20.79c.89.33 2-.47 2.51-1.79s.2-2.67-.68-3s-2 .46-2.51 1.78s-.25 2.67.68 3.01" />
	<path fill="#525252" d="M8.27 19.49c.51-1.33 1.63-2.13 2.51-1.79a1.42 1.42 0 0 1 .8.93c.32-1.19 0-2.33-.8-2.63s-2 .46-2.51 1.78a3.2 3.2 0 0 0-.11 2.08a2.3 2.3 0 0 1 .11-.37" />
	<path fill="none" stroke="#45413c" stroke-linecap="round" stroke-linejoin="round" d="M9 20.79c.89.33 2-.47 2.51-1.79s.2-2.67-.68-3s-2 .46-2.51 1.78s-.25 2.67.68 3.01" />
	<path fill="#87898c" d="M23.87 39c-.36 1.37-2.37 2-4.51 1.48S15.8 38.32 16.15 37s2.38-2 4.51-1.47s3.57 2.06 3.21 3.47" />
	<path fill="#525252" d="M20.66 37.12a4.57 4.57 0 0 1 3.05 2.21a1.5 1.5 0 0 0 .16-.37c.36-1.37-1.08-2.93-3.21-3.48s-4.15.1-4.51 1.47a1.9 1.9 0 0 0 .16 1.27c.6-1.11 2.42-1.61 4.35-1.1" />
	<path fill="none" stroke="#45413c" stroke-linecap="round" stroke-linejoin="round" d="M23.87 39c-.36 1.37-2.37 2-4.51 1.48S15.8 38.32 16.15 37s2.38-2 4.51-1.47s3.57 2.06 3.21 3.47" />
	<path fill="#87898c" d="M35.97 27.13a1.99 1.99 0 1 0 3.98 0a1.99 1.99 0 1 0-3.98 0" />
	<path fill="#525252" d="M38 26.63a2 2 0 0 1 1.84 1.25a1.9 1.9 0 0 0 .15-.75a2 2 0 0 0-4 0a2 2 0 0 0 .15.75A2 2 0 0 1 38 26.63" />
	<path fill="none" stroke="#45413c" stroke-linecap="round" stroke-linejoin="round" d="M35.97 27.13a1.99 1.99 0 1 0 3.98 0a1.99 1.99 0 1 0-3.98 0" />
	<path fill="#87898c" d="M13.75 25.42a1.99 1.99 0 1 0 3.98 0a1.99 1.99 0 1 0-3.98 0" />
	<path fill="#525252" d="M15.74 24.85a2 2 0 0 1 1.86 1.29a2.1 2.1 0 0 0 .13-.72a2 2 0 1 0-4 0a2.1 2.1 0 0 0 .13.72a2 2 0 0 1 1.88-1.29" />
	<path fill="none" stroke="#45413c" stroke-linecap="round" stroke-linejoin="round" d="M13.75 25.42a1.99 1.99 0 1 0 3.98 0a1.99 1.99 0 1 0-3.98 0" />
	<path fill="#87898c" d="M15.45 14.32a3.42 3.42 0 1 0 6.84 0a3.42 3.42 0 1 0-6.84 0" />
	<path fill="#525252" d="M18.87 13a3.4 3.4 0 0 1 3.23 2.35a3.1 3.1 0 0 0 .19-1.06a3.42 3.42 0 1 0-6.84 0a3.4 3.4 0 0 0 .19 1.06A3.41 3.41 0 0 1 18.87 13" />
	<path fill="none" stroke="#45413c" stroke-linecap="round" stroke-linejoin="round" d="M15.49 14.32a3.42 3.42 0 1 0 6.84 0a3.42 3.42 0 1 0-6.84 0" />
	<path fill="#87898c" d="M24.57 30.27a2.85 2.85 0 1 0 5.7 0a2.85 2.85 0 1 0-5.7 0" />
	<path fill="#525252" d="M27.42 29.13a2.83 2.83 0 0 1 2.7 2a2.7 2.7 0 0 0 .15-.85a2.85 2.85 0 1 0-5.7 0a3 3 0 0 0 .14.85a2.86 2.86 0 0 1 2.71-2" />
	<path fill="none" stroke="#45413c" stroke-linecap="round" stroke-linejoin="round" d="M24.57 30.27a2.85 2.85 0 1 0 5.7 0a2.85 2.85 0 1 0-5.7 0" />
</svg>
)