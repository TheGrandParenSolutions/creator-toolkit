...
const YoutubeThumbnailTestDashboard = () => {
  ...
  return (
    <div className="flex flex-col scroll-smooth transition-all duration-500 sm:overflow-y-hidden md:flex-row lg:h-[calc(100vh-58px)]">
      ...
      <div className="dark:bg-dark-black  flex w-full flex-col  items-center  scroll-smooth px-0 sm:overflow-y-scroll md:px-4">
        <div style={{ maxWidth: "100%" }}>
          <div className="dark:bg-dark-black top-0 z-[200] mb-6 w-full  pb-1">
            <div>
              <div className="dark:bg-dark-black relative z-20 flex h-[56px] w-full items-center justify-between ">
                <div
                  id="logos"
                  className="hidden flex-none items-center sm:flex"
                >
                  <Menu size={28} className="mr-4" />
                ...
                >
                  <div
                    className="border-1 ml-8 mr-1 flex items-center justify-between rounded-3xl border dark:border-[#303030]"
                  ...
                  >
                    ...
                    <button className="border-1 float-right flex h-10 w-16 flex-none items-center justify-center rounded-r-3xl border bg-gray-200 dark:border-[#303030] dark:bg-gray-700">
                      <Search />
                    </button>
                  </div>
                  <div className="ml-1 flex h-10 w-10 flex-none items-center justify-center rounded-full dark:bg-gray-700">
                    <MicrophoneSolid size={28} />
                  </div>
                </div>
