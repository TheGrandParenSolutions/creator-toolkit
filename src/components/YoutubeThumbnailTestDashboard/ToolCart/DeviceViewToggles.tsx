...
const DeviceViewToggles = ({
  ...
  return (
    <div className="relative flex w-full max-w-md justify-between rounded-full border-2 border-solid border-[var(--brand-dark-orange)] bg-gray-50 dark:bg-gray-800 px-1 py-1">
      {/* Active Background */}
      <div
